"use strict";var Tt=Object.create;var w=Object.defineProperty;var gt=Object.getOwnPropertyDescriptor;var ft=Object.getOwnPropertyNames;var St=Object.getPrototypeOf,bt=Object.prototype.hasOwnProperty;var ht=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},se=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of ft(e))!bt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=gt(e,n))||s.enumerable});return r};var M=(r,e,t)=>(t=r!=null?Tt(St(r)):{},se(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),It=r=>se(w({},"__esModule",{value:!0}),r);var Ut={};ht(Ut,{generateContext:()=>te});module.exports=It(Ut);var ut=M(require("path"),1),lt=require("os"),Et=require("fs");var ge=require("bun:sqlite");var b=require("path"),de=require("os"),pe=require("fs");var ce=require("url");var N=require("fs"),$=require("path"),oe=require("os");var re="bugfix,feature,refactor,discovery,decision,change",ne="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var y=class{static DEFAULTS={AI_MEM_MODEL:"claude-sonnet-4-5",AI_MEM_CONTEXT_OBSERVATIONS:"50",AI_MEM_WORKER_PORT:"37777",AI_MEM_WORKER_HOST:"127.0.0.1",AI_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",AI_MEM_ANTHROPIC_API_KEY:"",AI_MEM_PROVIDER:"claude",AI_MEM_CLAUDE_AUTH_METHOD:"cli",AI_MEM_GEMINI_API_KEY:"",AI_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",AI_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",AI_MEM_OPENROUTER_API_KEY:"",AI_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",AI_MEM_OPENROUTER_SITE_URL:"",AI_MEM_OPENROUTER_APP_NAME:"ai-mem",AI_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",AI_MEM_OPENROUTER_MAX_TOKENS:"100000",AI_MEM_DATA_DIR:(0,$.join)((0,oe.homedir)(),".claude","ai-mem-data"),AI_MEM_LOG_LEVEL:"INFO",CLAUDE_CODE_PATH:"",AI_MEM_MODE:"code",AI_MEM_CONTEXT_SHOW_READ_TOKENS:"false",AI_MEM_CONTEXT_SHOW_WORK_TOKENS:"false",AI_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",AI_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",AI_MEM_CONTEXT_OBSERVATION_TYPES:re,AI_MEM_CONTEXT_OBSERVATION_CONCEPTS:ne,AI_MEM_CONTEXT_FULL_COUNT:"0",AI_MEM_CONTEXT_FULL_FIELD:"narrative",AI_MEM_CONTEXT_SESSION_COUNT:"10",AI_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",AI_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false",AI_MEM_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",AI_MEM_FOLDER_CLAUDEMD_ENABLED:"false",AI_MEM_MAX_CONCURRENT_AGENTS:"2",AI_MEM_EXCLUDED_PROJECTS:"",AI_MEM_FOLDER_MD_EXCLUDE:"[]",AI_MEM_EMBEDDING_MODEL:"Xenova/all-MiniLM-L6-v2",AI_MEM_EMBEDDING_DIMENSIONS:"384"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){let t=this.get(e);return t==="true"||t===!0}static applyEnvOverrides(e){let t={...e};for(let s of Object.keys(this.DEFAULTS))process.env[s]!==void 0&&(t[s]=process.env[s]);return t}static loadFromFile(e){try{if(!(0,N.existsSync)(e)){let i=this.getAllDefaults();try{let a=(0,$.dirname)(e);(0,N.existsSync)(a)||(0,N.mkdirSync)(a,{recursive:!0}),(0,N.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.log("[SETTINGS] Created settings file with defaults:",e)}catch(a){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,a)}return this.applyEnvOverrides(i)}let t=(0,N.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,N.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),console.log("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(i){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,i)}}let o={...this.DEFAULTS};for(let i of Object.keys(this.DEFAULTS))n[i]!==void 0&&(o[i]=n[i]);return this.applyEnvOverrides(o)}catch(t){return console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t),this.applyEnvOverrides(this.getAllDefaults())}}};var A=require("fs"),L=require("path"),ae=require("os"),H=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(H||{}),ie=(0,L.join)((0,ae.homedir)(),".claude","ai-mem-data"),W=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,L.join)(ie,"logs");(0,A.existsSync)(e)||(0,A.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,L.join)(e,`ai-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,L.join)(ie,"settings.json");if((0,A.existsSync)(e)){let t=(0,A.readFileSync)(e,"utf-8"),n=(JSON.parse(t).AI_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=H[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),p=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${p}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=H[e].padEnd(5),p=t.padEnd(6),c="";n?.correlationId?c=`[${n.correlationId}] `:n?.sessionId&&(c=`[session-${n.sessionId}] `);let _="";o!=null&&(o instanceof Error?_=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`:this.getLevel()===0&&typeof o=="object"?_=`
`+JSON.stringify(o,null,2):_=" "+this.formatData(o));let u="";if(n){let{sessionId:E,memorySessionId:g,correlationId:h,...l}=n;Object.keys(l).length>0&&(u=` {${Object.entries(l).map(([f,O])=>`${f}=${O}`).join(", ")}}`)}let T=`[${i}] [${a}] [${p}] ${c}${s}${u}${_}`;if(this.logFilePath)try{(0,A.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",u={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},m=new W;var Nt={};function Ot(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,ce.fileURLToPath)(Nt.url))}var Rt=Ot(),R=y.get("AI_MEM_DATA_DIR"),v=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,de.homedir)(),".claude"),Yt=(0,b.join)(v,"plugins","marketplaces","bdmorin"),qt=(0,b.join)(R,"archives"),Kt=(0,b.join)(R,"logs"),Jt=(0,b.join)(R,"trash"),Qt=(0,b.join)(R,"backups"),zt=(0,b.join)(R,"modes"),Zt=(0,b.join)(R,"settings.json"),me=(0,b.join)(R,"ai-mem.db"),es=(0,b.join)(R,"vector-db"),ts=(0,b.join)(R,"observer-sessions"),ss=(0,b.join)(v,"settings.json"),rs=(0,b.join)(v,"commands"),ns=(0,b.join)(v,"CLAUDE.md");function _e(r){(0,pe.mkdirSync)(r,{recursive:!0})}function ue(){return(0,b.join)(Rt,"..")}var le=require("crypto");var At=3e4;function Ee(r,e,t){return(0,le.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function Te(r,e,t){let s=t-At;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var U=class{db;constructor(e=me){e!==":memory:"&&_e(R),this.db=new ge.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i){let a=i??Date.now(),p=new Date(a).toISOString(),c=Ee(e,s.title,s.narrative),_=Te(this.db,c,a);if(_)return{id:_.id,createdAtEpoch:_.created_at_epoch};let T=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,p,a);return{id:Number(_.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let p=a??Date.now(),c=new Date(p).toISOString();return this.db.transaction(()=>{let u=[],T=this.db.prepare(`
      ...
      `);for(let g of s){let h=T.run(e,t,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),o||null,i,c,p);u.push(Number(h.lastInsertRowid))}let E=null;if(n){let h=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let f=g.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),a||null,p,u,_);E.push(Number(f.lastInsertRowid))}let h;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  ...
  `).all(e,...s,...o,t.totalObservationCount)}function Q(r,e,t){return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+Y)}function Re(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
...
`}function st(r,e,t,s){let n=[];return s?n.push(...Be(r)):n.push(...Ce(r)),s?n.push(...He()):n.push(...Me()),s?n.push(...We()):n.push(...Le()),s?n.push(...Ve()):n.push(...De()),P(t)&&(s?n.push(...Ye(e,t)):n.push(...xe(e,t))),n}var ee=M(require("path"),1);function B(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ot(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function it(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function rt(r,e){return ee.default.isAbsolute(r)?ee.default.relative(e,r):r}function at(r,e,t){let s=B(r);if(s.length>0)return rt(s[0],e);if(t){let n=B(t);if(n.length>0)return rt(n[0],e)}return"General"}function Mt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=it(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?B(r.facts).join(`
`):null}function Dt(r,e,t,s,n,o){let i=[];o?i.push(...qe(r)):i.push(...ke(r));let a=null,p="",c=!1;for(let _ of e)if(_.type==="summary"){c&&(i.push(""),c=!1,a=null,p="");let u=_.data,T=nt(u.displayTime);o?i.push(...ze(u,T)):i.push(...Fe(u,T))}else{let u=_.data,T=at(u.files_modified,n,u.files_read),E=ot(u.created_at),g=E!==p,h=g?E:"";p=E;let l=t.has(u.id);if(T!==a&&(c&&i.push(""),o?i.push(...Ke(T)):i.push(...we(T)),a=T,c=!0),l){let S=Lt(u,s);o?i.push(...Qe(u,E,g,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...Ue(u,h,S,s)),a=null)}else o?i.push(Je(u,E,g,s)):i.push($e(u,h,s))}return c&&i.push(""),i}function dt(r,e,t,s,n){let o=[],i=Mt(r);for(let[a,p]of i)o.push(...Dt(a,p,e,t,s,n));return o}function pt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ct(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,d.blue)),t.push(...k("Learned",r.learned,d.yellow)),t.push(...k("Completed",r.completed,d.green)),t.push(...k("Next Steps",r.next_steps,d.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function mt(r,e){return e?Ze(r):Pe(r)}function _t(r,e,t){return!P(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?et(r.totalDiscoveryTokens,r.totalReadTokens):Xe(r.totalDiscoveryTokens,r.totalReadTokens)}var xt=ut.default.join((0,lt.homedir)(),".claude","plugins","marketplaces","bdmorin","plugin",".install-version");function kt(){try{return new U}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Et.unlinkSync)(xt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function wt(r,e){return e?tt(r):je(r)}function $t(r,e,t,s,n,o,i){let a=[],p=K(e);a.push(...st(r,p,s,i));let c=t.slice(0,s.sessionCount),_=Ae(c,t),u=Z(e,_),T=ye(e,s.fullObservationCount);a.push(...dt(u,T,s,n,i));let E=t[0],g=e[0];pt(s,E,g)&&a.push(...ct(E,i));let h=z(e,s,o,n);return a.push(...mt(h,i)),a.push(..._t(p,s,i)),a.join(`
`).trimEnd()}async function te(r,e=!1){let t=V(),s=r?.cwd??process.cwd(),n=Se(s),o=r?.projects||[n],i=kt();if(!i)return"";try{let a=o.length>1?Re(i,o,t):J(i,n,t),p=o.length>1?Ne(i,o,t):Q(i,n,t);return a.length===0&&p.length===0?wt(n,e):$t(n,a,p,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
