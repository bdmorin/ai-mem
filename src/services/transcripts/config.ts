...
export const DEFAULT_CONFIG_PATH = join(homedir(), '.claude', 'ai-mem-data', 'transcript-watch.json');
export const DEFAULT_STATE_PATH = join(homedir(), '.claude', 'ai-mem-data', 'transcript-watch-state.json');
